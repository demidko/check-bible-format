...
стиха (цифрой). Вот пример файла оформленного в полном соответствии с этим форматом: [rst.html](https://github.com/demidko/BibleQuote/blob/main/src/main/resources/bible/rst.html)
